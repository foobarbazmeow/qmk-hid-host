...
impl Keyboard {
    pub fn new(device: &Device, reconnect_delay: u64) -> Self {
        return Self {
            ...
            vendor_id: device.vendor_id.unwrap_or(57638),
    ...
    fn get_device_info(hid_api: &HidApi, product_id: &u16, vendor_id: &u16, usage: &u16, usage_page: &u16) -> Option<DeviceInfo> {
    ...
    pub fn connect(
        ...
        std::thread::spawn(move || {
            ...
            loop {
                ...
                if let Some(device_info) = Self::get_device_info(&hid_api, &pid, &vid, &usage, &usage_page) {
